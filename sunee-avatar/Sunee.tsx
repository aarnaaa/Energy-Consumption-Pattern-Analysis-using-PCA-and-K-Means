...
import { avatarData, type AnimationName } from './sunee.avatar'

export type { AnimationName } from './sunee.avatar'
...
export const Sunee = forwardRef<AvatarHandle, AvatarProps>(function Sunee(
  {
    animation = "sleeping",
    playing = true,
    loop,
